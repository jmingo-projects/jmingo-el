...
/**
 * Test for {@link com.jmingo.el.jexl.JexlELEngine}.
 */
public class JexlELEngineTest {

    private ELEngine jexlELEngine = ELEngineFactory.getElEngine();
    ...
    public void testVerify(String exp, Map<String, Object> parameters, boolean result) {
        assertEquals(jexlELEngine.evaluate(exp, parameters), result);
    }
